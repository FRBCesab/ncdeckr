...
Conduct](https://github.com/frbcesab/ncdeckr/blob/main/CODE_OF_CONDUCT.md).
...
- Use the template
  [other_issue.md](https://github.com/frbcesab/ncdeckr/blob/main/.github/ISSUE_TEMPLATE/other_issue.md).
...
- To see if other users have experienced (and potentially already
  ...
  tracker](https://github.com/frbcesab/ncdeckr/issues?q=label%3Abug).
...
- Open a new [Issue](https://github.com/frbcesab/ncdeckr/issues/new).
- Use the template
  [bug_report.md](https://github.com/frbcesab/ncdeckr/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).
...
- Perform a [search](https://github.com/frbcesab/ncdeckr/issues) to see
...
Issues](https://github.com/frbcesab/ncdeckr/issues).

- Open a new [Issue](https://github.com/frbcesab/ncdeckr/issues/new).
- Use the template
  [feature_request.md](https://github.com/frbcesab/ncdeckr/blob/main/.github/ISSUE_TEMPLATE/feature_request.md).
...
7.  Submit a [Pull
    ...
    on the [original repo](https://github.com/frbcesab/ncdeckr/compare).
